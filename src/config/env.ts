...
const schema = z.object({
  ...
  JOB_RUN_RETENTION_DAYS: z.coerce.number().default(90),
  JOB_QUEUE_RETENTION_DAYS: z.coerce.number().default(30),
  FEED_QUALITY_RETENTION_DAYS: z.coerce.number().default(180),
